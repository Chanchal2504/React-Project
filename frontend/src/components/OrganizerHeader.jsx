...
export default function OrganizerHeader() {
  ...
  return (
    <div className="flex">
      ...
      {/* Side Section */}
      <aside className="w-64 min-h-screen bg-teal-200 shadow-md fixed top-0 left-0 pt-12 mt-16">
        <div className="flex flex-col space-y-4 px-6">
          {user?.image && (
            <img
              ...
              alt="Profile"
              className="w-16 h-16 rounded-full object-cover border-2 border-gray-300 mx-auto mb-2 cursor-pointer"
            />
          )}
          {isOpen && (
            <div
          ...
          <nav className="flex flex-col space-y-3 mt-6 ">
            ...
            <a
              href="/venue/viewrequests"
              className="px-3 py-2 rounded transition font-medium"
            >
              View Requests
            </a>
            <a
              href="/venue/viewbookings"
              className="px-3 py-2 rounded transition font-medium"
            >
              Booking History
            </a>
